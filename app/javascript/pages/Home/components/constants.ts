...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Carlos+Mendez&background=028090&color=fff&size=80&bold=true&format=svg",
    initials: "CM",
  },
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Sarah+Chen&background=02C39A&color=fff&size=80&bold=true&format=svg",
    initials: "SC",
  },
  {
    ...
    avatar: "https://ui-avatars.com/api/?name=Miguel+Torres&background=0D1B2A&color=02C39A&size=80&bold=true&format=svg",
    initials: "MT",
  },
];
