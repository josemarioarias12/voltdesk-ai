...
export default function OnboardingPlanShow({ plan, user }: Props) {
  ...
  return (
    <AppLayout title="Onboarding Plan">
      <div style={{ maxWidth: '900px' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '12px', color: '#94A3B8' }}>
              Started {plan.started_at} · Target: {plan.target_completion_date ?? 'TBD'}
            </span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
            <span style={{ fontSize: '14px', fontWeight: '600', color: '#0F172A' }}>Overall Progress</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px', marginBottom: '24px' }}>
          {[
            { label: 'Tasks Completed', value: `${doneTasks}/${totalTasks}`, sub: 'tasks done' },
            { label: 'Days Since Start', value: plan.started_at, sub: 'started' },
            { label: 'Target Date', value: plan.target_completion_date ?? 'TBD', sub: 'completion' },
          ].map((card, i) => (
            <div key={i} style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: '11px', color: '#475569', margin: 0 }}>{sectionDone}/{section.tasks.length} completed</p>
                    </div>
                  </div>
                  <span style={{
