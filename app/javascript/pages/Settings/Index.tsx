...
export default function SettingsIndex({ workspace, provider_models, cost_table }: Props) {
  ...
  const availableModels: string[] = useMemo(() => {
    ...
    console.log('provider:', provider, 'models:', models)
  ...
  function handleProviderChange(p: string) {
    ...
    console.log('Changing provider to:', p, 'models:', models, 'first:', firstModel)
    setProvider(p)
    setModel(firstModel)
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: '#475569' }}>
            Configure the AI provider and model used for ticket classification across your workspace.
          </p>
        </div>
        ...
        <div className="rounded-2xl border p-6" style={{ background: '#fff', borderColor: '#E2E8F0', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
          ...
          <div className="flex gap-3">
            {(['automatic', 'manual'] as const).map(m => (
              ...
              >
                {m === 'automatic' ? '⚡ Automatic' : '🎛️ Manual'}
